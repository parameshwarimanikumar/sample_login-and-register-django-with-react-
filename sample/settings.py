...
SECRET_KEY = 'django-insecure-5floa9qnsy-%@^yrt!-7yi#tra=62va*gay5q^-m^_pt3isadu'
...
MIDDLEWARE = [
    ...
    # 'path.to.custom.SessionMiddleware',  # Comment this out if you don't have a custom session middleware
